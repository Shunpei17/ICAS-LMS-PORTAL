...
<head>
    <meta charset="UTF-8">
    <title>Forgot Password | ICAS LMS</title>
...
<div class="text-center w-full max-w-sm">
    <div class="text-center mb-8">
        ...
        <p class="mt-2 text-[#388e3c] text-sm font-bold">PASSWORD RECOVERY</p>
    </div>
    ...
    <div class="bg-[#52af59] p-8 rounded-[2rem] shadow-xl border border-white/20 text-white">
        ...
        <p class="text-sm text-white/85 mt-2">Enter your email and we will send you a reset link.</p>
