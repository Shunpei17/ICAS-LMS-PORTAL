        ...
        <div class="grid w-full gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-6">
            ...
            <section id="auth-panel" class="auth-panel order-1 mx-auto w-full max-w-[560px] rounded-[2.4rem] p-5 text-white backdrop-blur-md sm:p-8 lg:order-2 lg:justify-self-end lg:p-8">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-white/85">Sign up as a student, faculty, or admin to begin.</p>
                </div>
                ...
                <div class="mt-5 rounded-2xl bg-white/10 p-4 lg:hidden">
                    ...
                    <ul class="mt-3 space-y-2 text-xs text-emerald-50/90">
                        ...
                        <li class="flex items-start gap-2"><span class="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-300"></span>Role-based access for student, faculty, admin</li>
                    </ul>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="mt-6">
                    ...
                    <div class="grid grid-cols-3 gap-1 rounded-full bg-black/15 p-1">
                        ...
                        <button type="button" onclick="setRole('admin')" id="btn-admin" data-role-btn="admin" class="role-btn role-btn-idle inline-flex h-11 items-center justify-center gap-1.5 rounded-full px-2 py-2 text-xs font-bold uppercase tracking-[0.08em] sm:text-sm">
